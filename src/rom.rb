	...
	MAP = {
		'data' => {
			...
			'models' => {
				...
				'login' => 'ROM::Login',
				'contact_address' => 'ROM::ContactAddress',
				'contact_group' => 'ROM::ContactGroup',
				'contact_group_user' => 'ROM::ContactGroupUser',
				'contact_contact_group' => 'ROM::ContactContactGroup',
				'type_address' => 'ROM::TypeAddress',
				'type_protection' => 'ROM::TypeProtection',
				'connection' => 'ROM::Connection',
				'mailbox' => 'ROM::Mailbox',
				'mailbox_user' => 'ROM::MailboxUser',
				'map' => 'ROM::Map',
				'tag' => 'ROM::Tag',
				'participant' => 'ROM::Participant',
				'mail' => 'ROM::Mail',
				'mail_participant' => 'ROM::MailParticipant',
				'mail_tag' => 'ROM::MailTag',
				'collection_mail' => 'ROM::CollectionMail',
				'attachment' => 'ROM::Attachment',
				'type_media' => 'ROM::TypeMedia',
				'media' => 'ROM::Media',
				'type_channel' => 'ROM::TypeChannel',
				'channel' => 'ROM::Channel',
				'channel_contact' => 'ROM::ChannelContact',
				'type_message' => 'ROM::TypeMessage',
				'message' => 'ROM::Message'
			},
